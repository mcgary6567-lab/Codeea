/* Prometheus clone — interactivity */
(function () {
  "use strict";
  ...
  var key = "prometheus_countdown_end";
  ...
  // Second countdown (Get Prometheus Now buy box) — kept in sync
  ...
  document.querySelectorAll(".yt-facade").forEach(function (facade) {
    function loadVideo() {
      ...
      iframe.title = "Prometheus platform video";
      facade.innerHTML = "";
