# PyInstaller spec for the macOS build of the Prometheus AI Crypto Bot.
# Build on a Mac with:  pyinstaller --noconfirm trading_bot_mac.spec
# Output: dist/Prometheus AI Crypto Bot.app  (windowed .app bundle)
#
...
app = BUNDLE(
    coll,
    name="Prometheus AI Crypto Bot.app",
    icon=_app_icon,
    bundle_identifier="tech.prometheusai.bot",
    info_plist={
        "CFBundleName": "Prometheus AI Crypto Bot",
        "CFBundleDisplayName": "Prometheus AI Crypto Bot",
