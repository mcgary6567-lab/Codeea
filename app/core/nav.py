...
ACADEMIC_GROUPS = [
    {"slug": "dashboards", "label": "Dashboards", "icon": "gauge", "blurb": "Clients, subscriptions, billing, performance", "items": [
        ...
        _i("Subscriptions (Multiple)", "/dashboards/subscriptions/amount", "coins", "dashboards.view"),
    ...
    {"slug": "config", "label": "Academic Configuration", "icon": "settings", "blurb": "Sessions, courses, packages, books, accounts", "items": [
        ...
        _i("QA Feedback Questions", "/academics/config/feedback-questions", "message-square-text", "academic_config.view"),
...
HR_GROUPS = [
    ...
    {"slug": "employment", "label": "Employment Management", "icon": "id-card", "blurb": "Records, requests, violations, bonuses", "items": [
        ...
        _i("Notifications", "/hr/notices", "megaphone", "employees.view"),
    ...
    {"slug": "attendance", "label": "Time and Attendance", "icon": "clock", "blurb": "Attendance, leaves, entitlements, progress", "items": [
        ...
        _i("Attendance Summary", "/hr/attendance/summary", "table-2", "employees.view"),
...
ADMIN_NAV = [
    ...
    {"slug": "self", "label": "Employee Self Portal", "icon": "user",
     "blurb": "Your attendance, requests, pay, team and record", "items": [
        _i("My Overview", "/hr/me", "layout-dashboard", "portal_self.view"),
        _i("My Schedule", "/hr/me?tab=schedule", "calendar-days", "portal_self.view"),
        _i("Requests", "/hr/me?tab=requests", "inbox", "portal_self.view"),
        _i("Attendance Sheet", "/hr/me?tab=attendance", "clock", "portal_self.view"),
        _i("Tasks", "/hr/me/tasks", "list-checks", "portal_self.view"),
        ...
        _i("Violations", "/hr/me?tab=violations", "shield-alert", "portal_self.view"),
        _i("Bonuses", "/hr/me?tab=bonuses", "gift", "portal_self.view"),
        _i("Salary Slips", "/hr/me?tab=payslips", "banknote", "portal_self.view"),
        _i("Notifications", "/hr/me/notices", "megaphone", "portal_self.view"),
        _i("Downloads", "/hr/downloads", "download", "portal_self.view"),
        _i("Complaints", "/hr/me?tab=complaints", "life-buoy", "portal_self.view"),
