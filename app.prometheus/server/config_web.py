...
DATA_DIR = os.environ.get("PROMETHEUS_DATA_DIR", os.path.join(os.path.dirname(__file__), "..", "data"))
...
os.environ.setdefault("PROMETHEUS_DATA_DIR", DATA_DIR)

DB_PATH = os.path.join(DATA_DIR, "prometheus_web.db")

# Public base URL the app advertises for TradingView webhooks (behind your TLS).
PUBLIC_URL = os.environ.get("PROMETHEUS_PUBLIC_URL", "").rstrip("/")
